...
interface SwitchesTableProps {
  switchRatings: Record<string, KeyboardSwitch>;
}

export const SwitchesTable = ({ switchRatings }: SwitchesTableProps) => {
  ...
  function getComparator(sortColumn: string): Comparator {
    switch (sortColumn) {
      ...
      case "score":
        return (a, b) => {
          const aScore = switchRatings[a.id]?.averageScore;
          const bScore = switchRatings[b.id]?.averageScore;
          if (!aScore && !bScore) {
            return 0;
          }
